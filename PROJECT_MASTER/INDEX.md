...
- ⭐ [plans/online-play-international.md](plans/online-play-international.md) — PROPOSED: Lichess-level platform at international scale (separate WS + game-engine tiers, Redis bus, fishnet, anti-cheat, tournaments); infra decision flagged
  - ↳ ⭐ [plans/online-play-realtime-architecture.md](plans/online-play-realtime-architecture.md) — PROPOSED (deep): realtime play architecture — grain directory (Orleans-style single-writer), uWS gateway tier, wire protocol, server-truth clocks, failure/recovery, M0–M5 build phases — **M0+M1 BUILT & verified**
