export const THEMES = [
  ...
  "attraction", "backRankMate", "balestraMate", "bishopEndgame", "blindSwineMate", "bodenMate",
  ...
  "doubleCheck", "dovetailMate", "endgame", "enPassant", "epauletteMate", "equality", "exposedKing",
