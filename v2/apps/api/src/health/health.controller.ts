...
export class HealthController {
   ...
   *
   *  This endpoint exists ONLY for the monitor. It was deleted in 6a58162 — a commit about
   *  live broadcast — and the fleet has alerted "subscription gateway check failing, HTTP 404"
   *  every six hours since. Nothing was wrong with payments; the check had no target. */
  @Get("payments")
  async payments() {
