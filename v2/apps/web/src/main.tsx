...
import LeaderboardComparePage from "./pages/LeaderboardCompare";
      ...
      <BrowserRouter basename={import.meta.env.BASE_URL.replace(/\/+$/, "")}>
        <Routes>
          ...
          <Route element={<App />}>
            ...
            <Route path="academy/compare" element={<ErrorBoundary label="Head-to-head compare"><LeaderboardComparePage /></ErrorBoundary>} />
