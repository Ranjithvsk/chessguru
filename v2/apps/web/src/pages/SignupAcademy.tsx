...
const FAQ = [
  { q: "Is my card required for the free trial?",
    a: "No. You get 30 days completely free — no card, no risk. After that it's ₹1,000/month for unlimited coaches and students." },
  { q: "How many students and coaches can I add?",
    a: "Unlimited on every plan, including the free trial. Add as many as you like — pricing does not change per seat." },
    ...
    <div className="relative rounded-3xl p-8 md:p-10 border border-white/10 shadow-2xl" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.03), rgba(0,0,0,0.4))" }}>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-black mt-3">{FEATURES.length}+ features. One price.</h2>
      ...
      <section id="pricing" className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="relative rounded-3xl p-8 md:p-12 border border-amber-400/30 shadow-2xl shadow-amber-500/10" style={{ background: "linear-gradient(180deg, rgba(251,191,36,0.05), rgba(0,0,0,0.4))" }}>
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full px-4 py-1 text-xs font-bold text-black" style={{ background: "linear-gradient(135deg, #fbbf24, #f59e0b)" }}>
            🎁 30 days FREE
          </div>
          <div className="text-center mb-8">
            <div className="text-5xl md:text-6xl font-black">
              <span style={{ background: "linear-gradient(135deg, #fbbf24, #f472b6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>₹1,000</span>
              <span className="text-xl opacity-70 font-normal"> / month</span>
            </div>
            <div className="text-sm opacity-70 mt-2">after your 3-month trial · cancel anytime</div>
          </div>
          <ul className="grid sm:grid-cols-2 gap-3 mb-8">
            {[
              "Unlimited coaches", "Unlimited students",
              "Live classes (Dream Meet built in)", "Rated puzzle trainer",
              "Fees + attendance + roster", "Analytics + per-theme heatmap",
              "Data export whenever you want", "No card required for trial",
            ].map((b, i) => (
          ...
          <button onClick={scrollToForm} className="w-full rounded-full py-3.5 font-bold text-black shadow-xl shadow-amber-500/30 text-base" style={{ background: "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)" }}>
            Start free — no card →
          </button>
        </div>
      </section>
