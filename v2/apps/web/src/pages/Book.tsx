...
const EM_PUZZLES: Puz[] = [
  ...
  { n: 67, num: "1-67", fen: "8/2R5/3KP3/8/2p1p1p1/3r4/8/6k1 w - - 0 1", page: 53, bb: [36.1, 60.0, 35.8, 25.2], side: "w", diff: "Exercise 1/21 · hold the balance", goal: "draw",
    ...
    rating: 2050, band: "Expert", emRate: { anchor: null, themes: [], confidence: "medium", signals: { onlyMoves: 0, trap: false, sfSubtle: false, dtm: 0, reciprocalZugzwang: false } } },
  { n: 68, num: "1-68", fen: "8/p7/5p2/2k2P2/8/2K5/P7/8 w - - 0 1", page: 54, bb: [38.2, 2.7, 35.8, 25.2], side: "w", diff: "Exercise 1/22 · hold the draw", goal: "draw",
    sol: ["a2a4", "a7a6", "a4a5", "c5b5", "c3d4", "b5a5", "d4c5"], sf: "Draw (½–½)", maia: "—",
    idea: "Exercise 1/22 (White to move, play it out): the a- and f-pawns are balanced by Black's a7 and f6 and the kings' opposition. White must not lose the a-pawn race — 1.a4! (not the hasty push that loses a tempo) and the position holds. A draw.",
    note: "Chapter 1 — Exercise 1/22. Tablebase-confirmed draw.",
    rating: 2131, band: "Expert", emRate: { anchor: null, themes: ["rook's pawn", "opposition", "fortress/defensive hold"], confidence: "high", signals: { onlyMoves: 4, trap: false, sfSubtle: false, dtm: 7, reciprocalZugzwang: false } } },
  { n: 69, num: "1-69", fen: "8/5p1p/8/K6k/8/8/PP6/8 w - - 0 1", page: 54, bb: [36.0, 65.0, 35.8, 25.2], side: "w", diff: "Pawn race · win (skewer)", goal: "win",
    sol: ["b2b4", "f7f5", "b4b5", "f5f4", "b5b6", "f4f3", "b6b7", "f3f2", "b7b8q", "f2f1q", "b8b5", "f1b5", "a5b5"], sf: "White wins", maia: "—",
    idea: "G. Walker, 1841. Both sides race and queen almost together — but White queens with tempo: 1.b4! f5 2.b5 f4 3.b6 f3 4.b7 f2 5.b8=Q f1=Q 6.Qb5+! Q×b5 7.K×b5 and the h-pawn will never queen. (Points 1 and 6 of the pawn-race list: skewer + queen trade.)",
    note: "Chapter 1 — Pawn Races: queen with check / skewer. Tablebase-verified win.",
    rating: 2050, band: "Expert", emRate: { anchor: null, themes: [], confidence: "medium", signals: { onlyMoves: 0, trap: false, sfSubtle: false, dtm: 0, reciprocalZugzwang: false } } },
  { n: 70, num: "1-70", fen: "8/8/4K3/8/8/5p1k/5P1P/8 w - - 0 1", page: 55, bb: [36.1, 8.4, 35.8, 25.2], side: "w", diff: "Study · hold the draw", goal: "draw",
    sol: ["e6d5", "h3g2", "h2h4", "g2f2", "h4h5", "f2e1", "h5h6", "f3f2", "h6h7", "f2f1q"], sf: "Draw (½–½)", maia: "—",
    idea: "J. Moravec, 1925. The ONLY move to draw is 1.Kd5! — heading to catch the runner while the h-pawn races: 1…Kg2! 2.h4 and White's pawn queens immediately after Black's. (1.Kf5? Kg2! and Black queens with check; 1.Ke5? Kg2! and after …Qa1+ White's queen falls.)",
    note: "Chapter 1 — Pawn Races: the only drawing move. Tablebase-confirmed draw.",
    rating: 2149, band: "Expert", emRate: { anchor: null, themes: ["rook's pawn", "fortress/defensive hold"], confidence: "high", signals: { onlyMoves: 4, trap: false, sfSubtle: false, dtm: 10, reciprocalZugzwang: false } } },
  { n: 71, num: "1-71", fen: "8/8/1p6/8/k7/3K4/5P2/8 w - - 0 1", page: 55, bb: [36.0, 46.3, 35.8, 25.2], side: "w", diff: "Study · win (shouldering)", goal: "win",
    sol: ["d3d4", "a4b5", "d4d5", "b5a6", "f2f4", "a6b7", "f4f5", "b7c7", "d5e6"], sf: "White wins", maia: "—",
    idea: "N. Grigoriev, 1928. Black's king is in the square of the f-pawn, so White must SHOULDER it away: 1.Kd4! (not 1.f4? Kb5=) b5 2.f4 b4 3.f5 b3 4.Kc3! Ka3 5.f6 b2 6.f7 b1=Q 7.f8=Q+ — winning the queen or mating. The king blocks the enemy king's path to the kingside.",
    note: "Chapter 1 — Pawn Races: shouldering + queen with check. Tablebase-verified win.",
    rating: 2281, band: "Expert", emRate: { anchor: null, themes: [], confidence: "high", signals: { onlyMoves: 2, trap: true, sfSubtle: false, dtm: 22, reciprocalZugzwang: false } } },
];
