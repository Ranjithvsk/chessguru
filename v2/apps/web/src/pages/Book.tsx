...
const EM_PUZZLES: Puz[] = [
  ...
  { n: 24, num: "1-24", fen: "3r4/3P4/p1k5/1p3pp1/1P5p/P4P1P/3r1KP1/8 b - - 0 1", page: 31, bb: [36, 59.7, 35.8, 25.1], side: "b", diff: "Exercise 1/6 · win (should Black simplify?)", goal: "win",
    ...
    rating: 2050, band: "Expert", emRate: { anchor: null, themes: [], confidence: "medium", signals: { onlyMoves: 0, trap: false, sfSubtle: false, dtm: 0, reciprocalZugzwang: false } } },
  { n: 25, num: "1-25", fen: "8/4pk2/p5p1/7p/R6P/4P3/P5r1/5K2 b - - 0 1", page: 32, bb: [36.0, 2.7, 35.8, 25.2], side: "b", diff: "Exercise 1/7 · Black is better", goal: "win",
    sol: ["g2h2"], sf: "Black is better (+1.2)", maia: "…Rh2",
    idea: "Exercise 1/7 (Black to move): Black is a pawn up with a raking rook on g2. Press it — 1…Rh2! wins the h4-pawn and ties White down, then bring the king in and roll the queenside majority. A model “active rook” rook ending.",
    note: "Chapter 1 — Exercise 1/7. Engine: Black is clearly better (extra pawn, active rook).",
